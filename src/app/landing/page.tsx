  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-5 md:px-12 bg-gradient-to-b from-black via-black/80 to-transparent backdrop-blur-[2px]">
      ...
      <div className="flex items-center gap-6 text-sm font-medium text-gray-400">
        <Link href="/" className="hidden md:flex items-center hover:text-white transition-colors gap-2">
          <Globe size={14} /> Global Events
        </Link>
        <Link href="/resale" className="hidden md:flex items-center hover:text-white transition-colors">
          Marketplace
        </Link>
        <Link
          href="/"
          className="bg-white text-black font-bold px-5 py-2.5 rounded-full transition-all duration-300 hover:bg-[#14F195] hover:shadow-[0_0_20px_rgba(20,241,149,0.4)] flex items-center gap-2"
        >
  ...
  return (
    <div className="relative w-full h-[550px] md:h-[100%] max-h-[800px] flex items-center justify-center perspective-1000">
      ...
      <FloatingElement delay={2} y={-15} className="absolute bottom-[20%] left-[-5%] md:left-[5%] z-20">
        <div className="bg-black/80 backdrop-blur-xl border border-white/10 px-4 py-2 rounded-full flex items-center gap-2 shadow-xl border-l-4 border-l-[#14F195]">
...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative w-full md:h-screen min-h-screen flex flex-col md:overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-6 md:px-12 flex-1 flex flex-col md:flex-row items-center justify-center relative z-10 pt-24 md:pt-0">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-start mt-10 md:mt-0 mb-14 md:mb-0">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-bold leading-[0.95] tracking-tighter text-white mb-6"
          >
            Global events.<br />
            Crypto native.<br />
          ...
          >
            <Link
              href="/"
              className="group relative bg-white text-black font-bold text-lg px-8 py-4 rounded-full overflow-hidden transition-all duration-300 hover:bg-[#14F195] hover:shadow-[0_0_30px_rgba(20,241,149,0.4)] text-center"
            >
            ...
            <Link
              href="/"
              className="px-8 py-4 rounded-full font-medium text-white border border-white/10 hover:bg-white/5 hover:border-[#9945FF]/50 transition-colors backdrop-blur-sm flex items-center justify-center gap-2"
            >
